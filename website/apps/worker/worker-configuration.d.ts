/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4de4685c6b2a8a527daed3ce9b5df756)
// Runtime types generated with workerd@1.20260921.1 2026-09-01
interface __BaseEnv_Env {
	AI: Ai;
	ALLOWED_ORIGINS: "https://wtf.plutokeating.beer,https://wordtoflush-web.pages.dev,http://localhost:5173";
	JUDGE_PROVIDER: string;
	ROOM: DurableObjectNamespace<import("./src/index").GameRoom>;
	MATCHMAKER: DurableObjectNamespace<import("./src/index").Matchmaker>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "GameRoom" | "Matchmaker";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "JUDGE_PROVIDER">> {}
}
